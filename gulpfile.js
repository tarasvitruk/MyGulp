...
gulp.task('scripts', function(){ // Создаем таск Scripts
	return gulp.src('app/js/main.js') // Берем источник
...
gulp.task('prod', ['clean', 'img', 'sass'], function() {

	var buildCss = gulp.src('app/css/**.min.css') // Переносим библиотеки в продакшен
...
gulp.task('default', ['sass', 'watch', 'browser-sync', 'scripts']);